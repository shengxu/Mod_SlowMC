    ...
    do i = 1, this%nisotopes
      if (this%isotopes(i)%doppler) then
        ...
        call LinInterp(this%isotopes(i)%engy_capt, this%isotopes(i)%xs_capt, &
             & E_brdn, this%isotopes(i)%xs_capt_brdn)
        this%isotopes(i)%xs_capt_brdn = v_brdn/v*this%isotopes(i)%xs_capt_brdn

        call LinInterp(this%isotopes(i)%engy_scat, this%isotopes(i)%xs_scat, &
             & E_brdn, this%isotopes(i)%xs_scat_brdn)
        this%isotopes(i)%xs_scat_brdn = v_brdn/v*this%isotopes(i)%xs_scat_brdn

        call LinInterp(this%isotopes(i)%engy_fiss, this%isotopes(i)%xs_fiss, &
             & E_brdn, this%isotopes(i)%xs_fiss_brdn)
        this%isotopes(i)%xs_fiss_brdn = v_brdn/v*this%isotopes(i)%xs_fiss_brdn
